...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFkZWhlbmRyaWNrcyIsImEiOiJja2FtazUzcGowMWpoMnNwNDV5eGF0eHUxIn0.a5_20XHj4knNk0zbzGjoaw';
  var map = new mapboxgl.Map({
    container: 'map',
    //will put the container on a elements with the ID of map
  ...
  var bounds = new mapboxgl.LngLatBounds(); // 1) loop through all the locations and add a marker for each of them
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend th emap bound to include the current locations
  ...
  map.fitBounds(bounds, {
    padding: {
      top: 200,
      //extra padding because of the design
      bottom: 150,
      left: 100,
      right: 100
    }
...
//need this to be added to our final bundle to polyfill
// DOM ELEMENTS
